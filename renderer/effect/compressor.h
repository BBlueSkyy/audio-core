...
public:
    ...
    /** Initialize REV13+ compressor statistics. */
    void InitializeResultState(EffectResultState& result_state) override;

    /** Copy the DSP-side REV13+ statistics to the host-visible result. */
    void UpdateResultState(EffectResultState& cpu_state,
                           EffectResultState& dsp_state) override;
